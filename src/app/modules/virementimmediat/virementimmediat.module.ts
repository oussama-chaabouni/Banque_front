...
import {VirementimmediatComponent} from "./virementimmediat.component";

const routes: Routes = [
  {
    path: '',
    component: VirementimmediatComponent
  }
]

@NgModule({
  declarations: [VirementimmediatComponent],
  bootstrap: [VirementimmediatComponent],
    imports: [
        CommonModule,
...
export class VirementimmediatModule {}
