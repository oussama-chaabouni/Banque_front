...
@Component({
  selector: 'app-afficherempsparticipants',
  templateUrl: './afficherempsparticipants.component.html',
  styleUrls: ['./afficherempsparticipants.component.scss']
})
export class AfficherempsparticipantsComponent implements OnInit {
  ...
  ngOnInit(): void {    //NGONINIT MA3NETHA LKHEDMA LI BECH TETKHDEM PAR DEFAUT
    this.afficherEmployesParticipants();
    this.formation= {
  ...
  afficherEmployesParticipants(){
    //idformation

    this.formationService.afficherEmployesParticipants(1).subscribe(res=> {
